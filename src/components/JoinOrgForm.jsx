	...
	return (
		...
		>
            ...
            value={formValues.is_active}
					...
					<button className="bg-blue-600 text-white rounded-lg p-1">Submit</button>
					<button className="bg-blue-600 text-white rounded-lg p-1" type="button" onClick={() => props.setToggleJoining(false)}>
						Cancel
					</button>
				</form>
			</div>
