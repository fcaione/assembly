				...
				{profile.organizations?.map((org) => (
					...
					>
						...
						{!org.is_active && <h2>No longer active</h2>}
							{user?.id === org.user_id && (
								<div>
									<button class="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm text-gray-500 hover:text-gray-700 focus:relative" onClick={() => handleUpdate(org)}
>
										<svg
									...
									<button class="inline-flex items-center gap-2 rounded-md bg-white px-4 py-2 text-sm text-blue-500 shadow-sm focus:relative" onClick={() => handleDelete(org)} >
										<svg
											xmlns="http://www.w3.org/2000/svg"
											fill="none"
											viewBox="0 0 24 24"
